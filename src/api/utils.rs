    ...
    T: for<'de> Deserialize<'de> + Send,
{
    String::from_utf8(body.clone())
        .map_err(ewrap!(ErrorSource::RequestUTF8, ErrorKind::BadRequest, body))
        .into_future()
        .and_then(|string| serde_json::from_str::<T>(&string).map_err(ewrap!(ErrorSource::RequestJson, ErrorKind::BadRequest, string)))
}
